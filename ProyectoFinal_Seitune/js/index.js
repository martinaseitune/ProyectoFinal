...
class Cotizacion{
    ...
    calcularTotal(){
        ...
        for (let i = 0; i < this.lista.length; i++) {
            this.total += this.lista[i].precioExtra * this.cantidadPersonas
        }

        this.total += this.cantidadPersonas * this.precioPersona;
    }
...
function validarInvitados(valor) {
    return (valor == null || valor.length == 0 || valor == isNaN || valor > 1500) ? false : true;
}
...
function mostrarPresupuesto(){
    ...
    let detallePresupuesto = document.getElementById("presupuestoInfo");
